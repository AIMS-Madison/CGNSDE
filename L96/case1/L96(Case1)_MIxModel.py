...
# mixmodel.load_state_dict(torch.load("/home/cc/CodeProjects/CGNSDE/L96/case1/L96(case1)_Model/L96(case1)_mixmodel1.pt"))
...
def SDESolver(model, u0, steps, dt, sigma_lst):
    ...
    for n in range(0, steps-1):
        ...
        u_simu[n+1] = u_simu[n] + u_dot_pred*dt + sigma*np.sqrt(dt)*torch.randn(dim)
    return u_simu
...
for ep in range(1, epochs+1):
    ...
    # if ep % 100 == 0:
    #     torch.save(mixmodel.state_dict(), r"/home/cc/CodeProjects/CGNN/L96/case1/L96(case1)_Model/L96(case1)_mixmodel2_ep"+str(ep) + ".pt")

# np.save(r"/home/cc/CodeProjects/CGNN/L96/case1/L96(case1)_Model/L96(case1)_mixmodel2_train_loss_history.npy", train_loss_history)
# np.save(r"/home/cc/CodeProjects/CGNN/L96/case1/L96(case1)_Model/L96(case1)_mixmodel2_train_loss_da_history.npy", train_loss_da_history)
...
# cgnn = CGNN()
# mixmodel = MixModel(cgnn)
# mixmodel.load_state_dict(torch.load("/home/cc/CodeProjects/CGNSDE/L96/case1/L96(case1)_Model/L96(case1)_mixmodel2_ep1000.pt"))
...
ax20.set_ylabel(r"$x_3$", fontsize=35, rotation=0, labelpad=8)
...
# ax11.set_xlim([-4, 4])
# ax21.set_xlim([-4, 4])
ax00.set_yticks([-10, 0, 10])
ax10.set_yticks([-10, 0, 10])
ax20.set_yticks([-10, 0, 10])
ax01.set_xticks([-10, 0, 10])
ax11.set_xticks([-10, 0, 10])
ax21.set_xticks([-10, 0, 10])
plt.show()
